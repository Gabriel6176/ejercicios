...
def print_resultado(linea, cuit, value, count, d1):
    ...
    lr=linecache.getline(APP_PATH+'\\'+d1+'.txt', linea)
    txt_row.insert(0.0, lr)
    #print(lr)
    #label_row.config(text=str(lr))
...
def test_cuit():
    ...
    if cuit>34999999999 or cuit<20000000001:
        ...
        buscar(linea, value, cuit, d1)
    
def buscar(linea, value, cuit, d1):
    if cuit>34000000000:
        busqueda1(linea, value, cuit, d1)
    else:
        busqueda2(linea, value, cuit, d1)

def busqueda1(linea, value, cuit, d1):
    count=1
    value=value
    d1=d1
    while True:
...
def busqueda2(linea, value, cuit, d1):
    count=1
    value=True
    count=1
    while True:
