...
#en la pagina inspeccionar
#ir a network headers y veo el que es post
#despues me muevo de headers a payload y veo que es lo que debo enviar de post en este caso dni:numero_dni
