#clase - herencia
#prioridad en herencia prioridad el de la izquierda (solo usa __init__ del primero nombrado)
#super() llama al metodo de la clase primaria
...
miBici=BicicletaElectrica("Marca 1", "Modelo 2")   
