...
def account_entry_1(row, local_vars, asiento_prefix, fecha_prefix, cta_cont_prefix, detalle_prefix, debe_prefix, haber_prefix, nota_prefix,
    ...
    row[debe_2_prefix] = local_vars['saldo_acreedor']#Esta el saldo_acreedor porque sino tendria el mismo valor en el asiento tanto debe como haber
    row[haber_2_prefix] = local_vars['saldo_deudor']#Esta el saldo_deudor porque sino tendria el mismo valor en el asiento tanto debe como haber
    if pd.isnull(local_vars['orden_pago']):
...
def account_entry_2(row, local_vars, asiento_3_prefix, fecha_3_prefix, cta_cont_3_prefix, detalle_3_prefix, debe_3_prefix, haber_3_prefix, nota_3_prefix,
    ...
    row[debe_4_prefix] = local_vars['saldo_acreedor']#Esta el saldo_acreedor porque sino tendria el mismo valor en el asiento tanto debe como haber
    row[haber_4_prefix] = local_vars['saldo_deudor']#Esta el saldo_deudor porque sino tendria el mismo valor en el asiento tanto debe como haber
...
def process_row(row):
    ...
    if local_vars['cod'] == 1:
        ...
        account_entry_1(row, local_vars, 
                        '#ASIENTO_1', '#FECHA_1', '#CTA_CONT_1', '#DETALLE_1', '#DEBE_1', '#HABER_1', '#NOTA_1',
                        '#ASIENTO_2', '#FECHA_2', '#CTA_CONT_2', '#DETALLE_2', '#DEBE_2', '#HABER_2', '#NOTA_2')
    elif local_vars['cod'] == 50.14:
        #--------------------ASIENTO 1 --------------------------------
        account_entry_1(row, local_vars, 
                        '#ASIENTO_1', '#FECHA_1', '#CTA_CONT_1', '#DETALLE_1', '#DEBE_1', '#HABER_1', '#NOTA_1',
                        '#ASIENTO_2', '#FECHA_2', '#CTA_CONT_2', '#DETALLE_2', '#DEBE_2', '#HABER_2', '#NOTA_2')
    elif local_vars['cod'] == 50.24:
        #--------------------ASIENTO 1 --------------------------------
        account_entry_1(row, local_vars, 
                        '#ASIENTO_1', '#FECHA_1', '#CTA_CONT_1', '#DETALLE_1', '#DEBE_1', '#HABER_1', '#NOTA_1',
                        '#ASIENTO_2', '#FECHA_2', '#CTA_CONT_2', '#DETALLE_2', '#DEBE_2', '#HABER_2', '#NOTA_2')
    elif local_vars['cod'] == 50.34:
        #--------------------ASIENTO 1 --------------------------------
        account_entry_1(row, local_vars, 
                        '#ASIENTO_1', '#FECHA_1', '#CTA_CONT_1', '#DETALLE_1', '#DEBE_1', '#HABER_1', '#NOTA_1',
                        '#ASIENTO_2', '#FECHA_2', '#CTA_CONT_2', '#DETALLE_2', '#DEBE_2', '#HABER_2', '#NOTA_2')        
    elif local_vars['cod'] == 50.44:
        #--------------------ASIENTO 1 --------------------------------
        account_entry_1(row, local_vars, 
                        '#ASIENTO_1', '#FECHA_1', '#CTA_CONT_1', '#DETALLE_1', '#DEBE_1', '#HABER_1', '#NOTA_1',
                        '#ASIENTO_2', '#FECHA_2', '#CTA_CONT_2', '#DETALLE_2', '#DEBE_2', '#HABER_2', '#NOTA_2')    
