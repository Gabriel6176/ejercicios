...
df_combined.apply(process_row, axis=1)
...
df_processed = df_combined.drop(columns=columns_to_exclude)
...
# Convert the "#ASIENTO" column to numeric
df_final["#ASIENTO"] = pd.to_numeric(df_final["#ASIENTO"], errors='coerce')

# Convert the "#FECHA" column to datetime
df_final["#FECHA"] = pd.to_datetime(df_final["#FECHA"], errors='coerce')

# Sort the DataFrame first by "#ASIENTO" and then by "#FECHA"
